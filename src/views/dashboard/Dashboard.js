    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Performance geral do aluno</h4>
        ...
        <CCardFooter>
          <td><span className="h6">Média das emoções do aluno:</span></td>
          <p></p>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Alegria</div>
              <strong>450 Vezes (45%)</strong>
              <CProgress
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Tristeza</div>
              <strong>103 Vezes (10%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="danger"
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Surpresa</div>
              <strong>150 Vezes (15%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="warning"
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Desprezo</div>
              <strong>50 Vezes (5%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="danger"
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Aversão</div>
              <strong>100 Vezes (10%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                value={10}
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Medo</div>
              <strong>148 Vezes (15%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                color="danger"
